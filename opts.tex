...
Finally, we acknowledge that new non-volatile memories are exposing code path
...
indicator that performance considerations are being addressed in similar
contexts, and recognize that our proposed system may further benefit from
